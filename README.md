...
- Licence, Master et Doctorat sont dans un carrousel horizontal qui avance automatiquement toutes les 4,5 secondes. Les flèches et les indicateurs restent utilisables.
...
2. Dans Cloudflare, va à **Workers & Pages > Create application > Pages > Connect to Git**. Sélectionne le dépôt. Pour un dépôt contenant directement ces fichiers, laisse le champ **Build command** vide et mets `/` dans **Build output directory**.
...
outputs/emoe-cloudflare/README.md
# Site E.M.O.E pour Cloudflare Pages
